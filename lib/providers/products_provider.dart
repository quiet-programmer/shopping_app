...
// getting a product by id.
  ...
  Future<void> fetchProduct() async {
    const url = "https://webservertut.firebaseio.com/products.json";

    try {
      final response = await http.get(url);
      var dataBreakDown = json.decode(response.body) as Map<String, dynamic>;
      final List<Products> loadedData = [];
      dataBreakDown.forEach((prodId, proData) {
